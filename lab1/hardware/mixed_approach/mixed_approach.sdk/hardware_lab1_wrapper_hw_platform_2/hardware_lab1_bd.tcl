...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CONST_VAL {7} CONFIG.CONST_WIDTH {4}  ] $ROW_POSITION
  ...
  set screen_object_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:screen_object:1.0 screen_object_0 ]

  # Create instance: xpos, and set properties
  set xpos [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 xpos ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS {0} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {4}  ] $xpos
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI] [get_bd_intf_pins xpos/S_AXI]

  # Create port connections
  connect_bd_net -net ROW_POSITION_dout [get_bd_pins ROW_POSITION/dout] [get_bd_pins screen_object_0/cy]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn1 [get_bd_pins buttons/s_axi_aresetn] [get_bd_pins leds/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins xpos/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs xpos/S_AXI/Reg] SEG_xpos_Reg
