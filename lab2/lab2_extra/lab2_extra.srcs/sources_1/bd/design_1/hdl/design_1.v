...
//Date        : Tue Oct 30 12:38:22 2018
//Host        : c4d2 running 64-bit Service Pack 1  (build 7601)
...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,da_board_cnt=1,da_ps7_cnt=1}" *) 
module design_1
   (btn,
    clk_in1,
    led,
