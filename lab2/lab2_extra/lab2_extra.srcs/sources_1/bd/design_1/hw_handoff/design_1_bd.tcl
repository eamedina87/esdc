...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.Assume_Synchronous_Clk {true} CONFIG.Enable_32bit_Address {false} CONFIG.Enable_A {Always_Enabled} CONFIG.Enable_B {Always_Enabled} CONFIG.Fill_Remaining_Memory_Locations {true} CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Operating_Mode_A {NO_CHANGE} CONFIG.Port_B_Clock {100} CONFIG.Port_B_Enable_Rate {100} CONFIG.Read_Width_B {3} CONFIG.Register_PortB_Output_of_Memory_Primitives {false} CONFIG.Remaining_Memory_Locations {7} CONFIG.Use_Byte_Write_Enable {false} CONFIG.Write_Depth_A {131072} CONFIG.Write_Width_A {3} CONFIG.Write_Width_B {3} CONFIG.use_bram_block {Stand_Alone}  ] $blk_mem_gen_0

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 clk_wiz_0 ]
  set_property -dict [ list CONFIG.CLKIN1_JITTER_PS {100.0} CONFIG.CLKOUT1_JITTER {320.187} CONFIG.CLKOUT1_PHASE_ERROR {246.739} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {25.000} CONFIG.CLKOUT1_USED {true}  ] $clk_wiz_0
  ...
  connect_bd_net -net f_div5_0_clkout [get_bd_pins VGA_SYNC_0/clock_25Mhz] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins session4_0/clk_25]
